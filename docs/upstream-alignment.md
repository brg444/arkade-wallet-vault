...
| `arkade-os/ts-sdk`      | Runtime `27f5c758`; package `8b40c76c`       | One exact Git-pinned `@arkade-os/sdk` 0.4.66 graph |
...
pins commit `8b40c76c` until that work is merged and released. That commit adds
